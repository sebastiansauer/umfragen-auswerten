...
Folgende R-Pakete werden für die Analyse benötigt. Bitte stellen Sie sicher, dass Sie diese Pakete vor Beginn der Analyse installiert haben. Sie installieren ein R-Paket mit dem Befehl `install.packages(name_des_pakets)`.
...
library(na.tools)  # Hilfen für fehlende Werte
#library(tidyimpute)  # fehlende Werte ersetzen
...
Die Daten stehen unter diesem Link zum Herunterladen bereit:
